...
urlpatterns = [
    ...
    path("series/search/", views.SearchSeriesView.as_view(), name="search-movie-view"),
    ...
    path("series/filter/genre/", views.GenreFilterSeries.as_view(), name="filter-series-by-genre"),
